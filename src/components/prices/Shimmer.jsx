  ...
  return (
    <section className="section-space">
      <div className="container">
        <div className="border border-gray-200 px-28 py-32 rounded-[2.5rem] laptop-l:rounded-[2rem] laptop-l:px-24 laptop-l:py-28 laptop-md:px-20 laptop-md:py-24 laptop:px-[4.5rem] laptop:py-[5.5rem] laptop-s:px-14 laptop-s:py-16 tab-s:p-12 tab:p-10 mb-l:p-8 mb-l:rounded-xl">
          <div className="flex justify-between flex-wrap pb-28 laptop-l:pb-20 mb-l:flex-col mb-l:">
